package com.dev.android_chat_app.ui.start.createAccount
...
import com.dev.android_chat_app.data.model.CreateUser
import com.dev.android_chat_app.ui.DefaultViewModel
import com.dev.android_chat_app.util.isEmailValid
import com.dev.android_chat_app.util.isTextValid
...
class CreateAccountViewModel : DefaultViewModel() {
    ...
    fun createAccountPressed() {
        ...
        if (!isTextValid(4, passwordText.value)) {
